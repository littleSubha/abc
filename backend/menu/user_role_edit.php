                ...
                <div class="card card-info">
                    <div class="card-header">
                        ...
                        <?php 
                            ...
                            $user_menuId=get_table_data('MNU_MST','MNM_MNCD,MNM_MNNM','MNM_CANC=1')->result(); 
                            $menutype_data1=get_table_data('MNU_TYP','MNT_TPCD,MNT_TPNM',"MNT_CANC = 1 ORDER BY MNT_TPNM")->result();  
            
                            ?>
                        <form  role="form" data-toggle="validator"  id="half_report_form" method="POST" enctype="multipart/form-data" action="<?= base_url('user_role_update/'.$userRole_data->USR_URCD);?>">  
                            <div class="card-body">  
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"> 
                                        ...
                                        <select class="form-control" name="USR_CTCD"   required>
                                            ...
                                            <option value="<?= $data->USC_CTCD;?>" <?= ($userRole_data->USR_CTCD ==$data->USC_CTCD)?'selected':''?>><?= $data->USC_CTNM;?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <!-- <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"> 
                                        <select class="form-control  " name="USR_MNCD"   required>
                                            <option value="">Select User Menu  </option>
                                            <?php foreach($user_menuId as $data){ ?>
                                            <option value="<?= $data->MNM_MNCD;?>" <?= ($userRole_data->USR_MNCD == $data->MNM_MNCD)?'selected':''?>><?= $data->MNM_MNNM;?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="help-block with-errors text-danger"></div>
                                    ...
                                    <div class="col-sm-9"> 
                                        <select class="select2 form-control" name="USR_MNCD" data-placeholder="Select Menu Name" autocomplete="off"   style="width: 100%;">
                                            ...
                                            <optgroup label="<?= $data->MNT_TPNM;?>">
                                                ...
                                                ?>
                                                    <option value="<?= $mdata->MNM_MNCD;?>" 
                                                    <?= ( $userRole_data->USR_MNCD == $mdata->MNM_MNCD)?'selected':''?>> 
                                                    <?= $mdata->MNM_MNNM;?> </option>
                                                    <?php } ?>
                                            </optgroup>
                                            <?php } ?>
                                        </select> 
                            ...
                            <button type="reset" class="btn btn-danger" onclick="window.history.back()"> <span class="btn-label btn-danger  btn-label"> </span> Back</button>
