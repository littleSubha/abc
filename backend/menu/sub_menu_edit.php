            ...
            <div class="col-10  mx-auto">
                <div class="card card-info">
                    <div class="card-header">
                        ...
                        <form autocomplete="off" role="form" data-toggle="validator"  id="half_report_form" method="POST" enctype="multipart/form-data" action="<?= base_url('sub_menu_update/'.$submenu_data->MNM_MNCD);?>">
                        <div class="card-body"> 
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9"> 
                                        <select class="form-control user_state" name="MNM_TPCD"   required>
                                            ...
                                            <option value="<?= $data->MNT_TPCD;?>" <?=  $submenu_data->MNM_TPCD ==$data->MNT_TPCD ?'selected':''?>><?= $data->MNT_TPNM;?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" name="MNM_MNNM" class="form-control" id="inputPassword3" placeholder="Enter Sub Menu Name" data-error="Enter Sub Menu Name" value="<?= $submenu_data->MNM_MNNM; ?>" required> 
                                        <div class="help-block with-errors text-danger"></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="number" name="MNM_SEQU" class="form-control" id="inputPassword3" placeholder="Enter Menu Sequence Number" data-error="Enter Menu Sequence Number" value="<?= $submenu_data->MNM_SEQU; ?>" required> 
                                        <div class="help-block with-errors text-danger"></div>
