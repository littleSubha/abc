            ...
            <div class="col-10  mx-auto">
                <div class="card card-info">
                    <div class="card-header">
                        ...
                        <!-- form start --> 
                        <form autocomplete="off" role="form" data-toggle="validator"  id="half_report_form" method="POST" enctype="multipart/form-data" action="<?= base_url('menu_group_update/'.$menu_data->MNT_TPCD);?>">

                            <div class="card-body"> 
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Menu Name<span class="text-danger ">*</span></label>
                                    <div class="col-sm-10">
                                     <input type="text" name="MNT_TPNM" class="form-control" id="inputPassword3" value="<?= $menu_data->MNT_TPNM;?>" placeholder="Enter Menu Name" data-error="Enter Menu Name" required> 
