                ...
                <div class="card card-primary"> 
                    ...
                    <div class="card-body">
                        <div class="float-center">
                            <form  id="" method="POST" enctype="multipart/form-data" action="<?= base_url('menu_group_add');?>">
                                <div class="row  ">
                                    <div class="col-sm-6 mx-auto">
                                        <div class="form-group"> 
                                            <label>Title<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="menugroup_name" placeholder="Enter Title"  value="<?= (set_value('menugroup_name'))?set_value('menugroup_name'):'';?>" > 
                                            ...
                                            <label>Menu Name <span class="text-danger">*</span></label>
                                                ...
                                                <optgroup label="<?= $data->menutype_name;?>">
                                                    ...
                                                    foreach($menu_data as $mdata){ ?>
                                                        <option value="<?= $mdata->menu_id;?>" <?= (set_value('menugroup_menus[]'))?'selected':''?>> <?= $mdata->menu_name;?> </option>
                                                    <?php } ?>
                                                </optgroup>
                                                <?php } ?>
                                                </select> 
