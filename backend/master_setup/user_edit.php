                    ...
                    <!-- /.card-header -->
                     <div class="card-body">
                        <div class="float-center">
                            <form  role="form" data-toggle="validator" id="" method="POST" enctype="multipart/form-data" action="<?= base_url('user_update/'.$user_data->user_id);?>">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group"> 
                                        <label>Full Name<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="user_name" placeholder="Enter User Name"  value="<?= $user_data->user_name ;?>" required> 
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="user_username" placeholder="Enter Full Name"   value="<?=$user_data ->user_username; ?>" required >
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="user_email" placeholder="Enter Email"   data-error="Enter Email"   value="<?= $user_data->user_email ;?>"required>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" class="form-control" name="user_mobile" placeholder="Enter Phone"   data-error="Enter Phone"  value="<?= $user_data->user_mobile;  ?>" required pattern="[0-9]{10}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Password</label> <span class="text-danger" >*</span></label>
                                                 <input type="text" class="form-control" name="user_password" placeholder="********"   data-error="Enter Master Name"  value="<?= $user_data->user_rawpsw ?>" required> 
                                        ...
                                        <div class="form-group">
                                            <label>User Role</label> <span class="text-danger" >*</span></label>
                                                <select class="form-control select-box user_role" name="user_role" required  data-error="Select Country"  >
                                                    ...
                                                    <option value="<?= $data->role_id;?>" <?= ($user_data->user_role)?'selected':'';?> ><?= $data->role_name;?></option>
                                                    <?php } ?>
                                                </select> 
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select-box user_country" name="user_country" required  data-error="Select Country" onchange="getState(this.value)">
                                                    ...
                                                    <option value="<?= $data->COM_COCD;?>" <?= ($user_data->user_country ==  $data->COM_COCD )?'selected':'';?>><?= $data->COM_CONM;?></option> 
                                                    <?php } ?>
                                                </select> 
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" maxlength="6" minlength="6" class="form-control" name="user_pincode" placeholder="Enter Pin Code "   data-error="Enter Pin Code " value="<?= $user_data->user_pincode ;?>" required> 
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="user_address" placeholder="Enter Address"   data-error="Enter Address" value="<?= $user_data->user_address ;?>" required> 
...
const getState =async (id)=>{
    ...
    if(jsonResponse){
        ...
        if(result.status == 200){
            ...
            var user_state="<?php echo $user_data->user_state ;?>";         
...
const getDistrict =async (id)=>{
    ...
    if(result.status == 200){
        ...
        var user_district="<?php echo $user_data->user_district ;?>"; 
        if(user_district){
...
const getBlock =async (id)=>{
    ...
    if(result.status == 200){
        ...
        var user_block="<?php echo $user_data->user_block ;?>"; 
         if(user_block){
...
const getVillage =async (id)=>{
    ...
    if(result.status == 200){
        ...
        var user_village="<?php  echo $user_data->user_village;?>"; 
        if(user_village){
