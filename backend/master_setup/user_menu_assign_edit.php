		...
		<div class="row">
		  	<div class="col-md-10 mx-auto">
	            <div class="card card-primary">
		            ...
		            <form role="form" data-toggle="validator" action="<?= base_url('menu_assign_update/'.$user_menu_assign_data->uml_id);?>" method="POST" >
		                <div class="card-body">
                            <div class="row"> 
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-box uml_userid" name="uml_userid"   data-error="Select User Name">
                                            ...
                                            <option value="<?= $data->user_id;?>" <?= ($user_menu_assign_data->uml_userid == $data->user_id )?'selected':'';?>><?= $data->user_name;?></option>
                                            <?php } ?>
                                        </select> 
                                        ...
                                        <div class="select2-pink ">
                                            <select class="select2 light_multip_section form-control" name="uml_menugpid[]" data-placeholder="Select Menu Group" autocomplete="off" multiple="multiple" style="width: 100%;">
                                                ...
                                                <?php foreach($menugroup_data as $data){  
                                                    $selected =in_array($data->menugroup_id,json_decode($user_menu_assign_data->uml_menugpid))? "selected" :null;?>
                                                    <option value="<?= $data->menugroup_id;?>"   <?=  $selected ?>><?= $data->menugroup_name;?></option>
                                                <?php } ?>
                                           </select> 
