		...
		<div class="row">
		  	<div class="col-md-10 mx-auto">
	            <div class="card card-primary">
		            ...
		            <form role="form" data-toggle="validator" action="<?= base_url('subcategory_add/'.$service_type);?>" method="POST" >
		                <div class="card-body">
                            <div class="row"> 
								<div class="col-6 mx-auto">
									<div class="form-group">
										...
										<select id="servic_type" name="sum_categoryid" class="form-control" required data-error="Select Category" >
											...
											<option value="<?= $data->cat_id;?>" <?= (set_value('sum_categoryid')==$data->cat_id)?'selected':'';?>> <?= $data->category;?>
											</option> 
											<?php endforeach;?> 
										</select>            
								...
								<div class="col-6 mx-auto">
									<div class="form-group">
										...
										<input type="text" name="sum_subcategory" class="form-control"   placeholder="Enter Sub Category" required data-error="Enter Sub Category" value="<?= (set_value('sum_subcategory'))?set_value('sum_subcategory'):'';?>">
										<div class="help-block with-errors  "></div>
