                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"   placeholder="Enter Teacher Full Name" data-error="Enter  Teacher Full Name" name="tem_name"   value="<?= set_value('tem_name');?>" required> 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"   placeholder="Enter Teacher  Father Name " data-error="Enter  Teacher  Father Name " name="tem_fathername"  value="<?= set_value('tem_fathername');?>" required> 
                                            <div class="help-block with-errors text-danger"></div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="Date" class="form-control" placeholder="Enter DOB" data-error=" Enter DOB" name="tem_dob" value="<?= set_value('tem_dob');?>"  required>
                                            <div class="help-block with-errors text-danger"></div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="mail" class="form-control" placeholder="Enter Teacher MAIL Id " data-error="enter User MAIL Id" name="tem_email" value="<?= set_value('tem_email');?>"   required>
                                            <div class="help-block with-errors text-danger"></div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            value="<?= set_value('tem_mob');?>"   required>
                                            <div class="help-block with-errors text-danger"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tem_designation_id" data-error="Select Designation" required>
                                                ...
                                                <?php foreach($common_designation as $data): ?>
                                                 <option value="<?= $data->COM_CMCD;?>" <?= (set_value('tem_designation_id')==$data->COM_CMCD)?'Selected':'';?>><?= $data->COM_CMNM;?></option>
                                                 <?php endforeach;?>
                                ...
                                <div class="row"> 
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="tem_scm_id" data-error="Select School"  required>
                                                ...
                                                <option value="<?= $data->scm_id;?>" <?= (set_value('tem_scm_id')==$data->scm_id)?'Selected':'';?>><?= $data->scm_udisecode;?>-<?= $data->scm_name;?></option>
                                                <?php endforeach;?>
                                            </select>
                                            <div class="help-block with-errors text-danger"></div>
                                    ...
                                    <div class="col-sm-6"> 
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tem_address" class="form-control " value="<?= set_value('tem_address');?>"  placeholder="Enter Address" data-error=" Enter Address"data-error="Enter Address" required>
                                            <div class="help-block with-errors text-danger"></div>
